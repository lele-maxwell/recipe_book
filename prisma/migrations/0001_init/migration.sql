...
CREATE TABLE "User" (
    ...
    "location" TEXT,
    "website" TEXT,
    "cookingExperience" TEXT,
    "favoritesCuisines" TEXT,
...
-- CreateIndex
CREATE INDEX "SocialMediaLink_platform_idx" ON "SocialMediaLink"("platform");

-- CreateIndex
CREATE UNIQUE INDEX "SocialMediaLink_userId_platform_key" ON "SocialMediaLink"("userId", "platform");
